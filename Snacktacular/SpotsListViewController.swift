...
class SpotsListViewController: UIViewController {
    ...
    func sortBasedOnSegmentPressed() {
        ...
        case 1: //closest
            spots.spotArray.sort(by: {$0.location.distance(from: currenLocation) < $1.location.distance(from: currenLocation)})
        case 2: // avgrating
            print("case 2")
        default:
            print("error")
...
extension SpotsListViewController: UIPageViewControllerDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let currentLocation = currenLocation {
...
extension SpotsListViewController: CLLocationManagerDelegate {
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        print("Current location is \(currentLocation.coordinate.longitude), \(currentLocation.coordinatelatitude)")
        sortBasedOnSegmentPressed()
    }
